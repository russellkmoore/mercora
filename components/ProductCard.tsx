        ...
        <div className="relative aspect-video bg-neutral-700">
          {primaryImageUrl ? (
            <Image
              ...
              placeholder="blur"
              blurDataURL="data:image/jpeg;base64,"
            />
          ) : (
