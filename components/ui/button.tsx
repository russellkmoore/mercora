  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-danger/20 dark:aria-invalid:ring-danger/40 aria-invalid:border-danger",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-danger text-foreground shadow-xs hover:bg-danger/90 focus-visible:ring-danger/20 dark:focus-visible:ring-danger/40 dark:bg-danger/60",
        outline:
          "border bg-surface shadow-xs hover:bg-surface-elevated hover:text-foreground dark:bg-surface-elevated/30 dark:border-border dark:hover:bg-surface-elevated/50",
        secondary:
          "bg-surface-elevated text-foreground shadow-xs hover:bg-surface-elevated/80",
        ghost:
          "hover:bg-surface-elevated hover:text-foreground dark:hover:bg-surface-elevated/50",
