/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: d82e02dcc9d111697441ee6c207105b6)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY" | "NEXT_PUBLIC_IMAGE_CDN">> {}
}
