/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 9f78860e45e2f6ad109630eb871b9acf)
// Runtime types generated with workerd@1.20260903.1 2026-08-01 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_CloudflareEnv {
	...
	NEXT_PUBLIC_THEME_DEFAULT: string;
	STORE_FEATURE_SUBSCRIPTION_RECONCILIATION: string;
	STORE_FEATURE_SUBSCRIPTION_ACQUISITION: string;
	STORE_SUBSCRIPTION_TERMS_VERSION: string;
	STORE_FEATURE_GIFT_CARD_RECONCILIATION: string;
	STORE_FEATURE_GIFT_CARD_ACQUISITION: string;
	EMAIL_PROVIDER: string;
	STORE_SENDER_EMAIL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY" | "NEXT_PUBLIC_IMAGE_CDN" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_THEME_DEFAULT" | "STORE_FEATURE_SUBSCRIPTION_RECONCILIATION" | "STORE_FEATURE_SUBSCRIPTION_ACQUISITION" | "STORE_SUBSCRIPTION_TERMS_VERSION" | "STORE_FEATURE_GIFT_CARD_RECONCILIATION" | "STORE_FEATURE_GIFT_CARD_ACQUISITION" | "EMAIL_PROVIDER" | "STORE_SENDER_EMAIL" | "STORE_SUPPORT_EMAIL">> {}
}
