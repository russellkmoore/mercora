...
| T-12-42 | Information Disclosure (data loss) | pre-deploy carts with a URL in the note dropped on load | low | accept | WINDOWS.md entry 10; paid orders unaffected — see AR-12-02 | closed (accepted) |
...
|---------|------------|-----------|-------------|------|
| AR-12-01 | T-12-37 | The sender address is Russell's live deployed configuration; a placeholder would stop real email on this demo site. Public config, documented in `docs/runtime-configuration.md`. | Russell (kept the live sender; milestone sign-off) | 2026-09-10 |
| AR-12-02 | T-12-42 | Pre-deploy carts whose gift note contains a URL lose that line silently on rehydrate; blast radius is stale browser carts, self-resolving. | Russell (milestone sign-off) | 2026-09-10 |
| AR-12-03 | T-12-30 | Four unattended production changes plus the review-fix range were pushed although 12-06's literal scope gate failed; each is tested, deployed, documented in STATE.md / 12-05-SUMMARY / 12-VALIDATION / 12-PROOF-ORDER §7. Demo site, reversible by revert. | Russell (`/gsd-verify-work 12 mark completed`; the fixes were exercised in his own live checkout) | 2026-09-10 |
...
| 2026-09-10 | 42 | 42 | 0 | Russell's sign-off via verify-work; AR-12-01..03 accepted |
