...
- [x] **Phase 8: Documentation & Visual QA Close-out** - Document the theming system, record a visual QA pass across presets x layout variants, and refresh the affected `.planning/codebase/` docs (completed 2026-09-05)
...
- [x] 07-04-PLAN.md — Admin Layout section: independent `LayoutSwitches` island with three radiogroups, one three-key save through the existing guarded settings endpoint, hosted below the theme grid
...
- [x] 08-04-PLAN.md — Judge the matrix against the six per-cell criteria, findings table with fixes and leave-its, summary table into `docs/theming.md`

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 08-05-PLAN.md — Targeted refresh of four `.planning/codebase/` docs, milestone close-out record, requirements marked ready, full gate suite
...
| 8. Documentation & Visual QA Close-out | v2 | 5/5 | Complete    | 2026-09-05 |
...
- [x] 08.2-02-PLAN.md — Seven remaining retirements with links, manifest and changelog in one commit; `scripts/docs-lint.mjs` and `npm run docs:lint` (D-03, D-04, D-05)
...
- [x] 08.2-04-PLAN.md — `AGENTS.md` written and tracked with the managed block preserved, root `CLAUDE.md` tracked, `docs/CLAUDE.md` trimmed (D-07, D-08, D-12)

**Wave 5** *(blocked on Wave 4)*

- [x] 08.2-05-PLAN.md — Seven optimised preset images, README rewritten product-neutral in the fixed section order, docs index regenerated (D-01, D-02, D-09, D-13)

**Wave 6** *(blocked on Wave 5)*

- [x] 08.2-06-PLAN.md — Style contract across the surviving set, whole-set claim check, validation record filled, DOCS-04/05 closed (D-05, D-06)
...
- [x] 08.1-03-PLAN.md — `scan:tokens` in CI, parity baselines fail loudly on a missing snapshot, settings seed fallback logs (D-03, D-06, D-07)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 08.1-02-PLAN.md — Transactional email builders take tokens; senders resolve the active theme once at send time (D-01)
- [x] 08.1-05-PLAN.md — One product-image resolver for both gallery variants; `productGallery` becomes required (D-05, D-11, D-08)
...
- [x] 08.1-06-PLAN.md — Validator rejects duplicate token declarations, one `kebabToCamel`, resolver branch collapse (D-08)
